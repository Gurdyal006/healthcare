        ...
        <div className="max-w-7xl mx-auto px-6 grid lg:grid-cols-2 gap-14 items-center">
          ...
          <div>
            ...
            <p className="mt-8 text-lg text-blue-100 leading-relaxed max-w-2xl">
              ...
              {doctor.about ||
                "Experienced healthcare specialist providing modern patient-centered treatment and consultation."}
            ...
            <div className="flex flex-wrap gap-4 mt-10">
              ...
              <Link
                href={`/appointments/create/${doctor._id}`}
                className="px-8 py-4 rounded-2xl bg-white text-slate-900 font-bold hover:scale-105 transition-all duration-300"
              >
                Book Appointment
              </Link>
        ...
        <div className="lg:col-span-2 space-y-10">
          ...
          <div className="bg-white rounded-[32px] border border-slate-200 p-10 shadow-sm">
            ...
            <p className="text-slate-600 text-lg leading-relaxed">
              ...
              {doctor.about ||
                "Professional healthcare specialist with years of experience in advanced diagnosis and patient treatment."}
          ...
          <div className="bg-white rounded-[32px] border border-slate-200 p-10 shadow-sm">
            ...
            <div className="bg-[#f5f9ff] rounded-[24px] p-6 border border-slate-200">
              ...
              <p className="text-slate-600 leading-relaxed">
                ...
                Amazing healthcare specialist with professional consultation and patient-focused treatment.
